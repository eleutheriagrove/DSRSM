...
A static dissipation symbol on a moving critical set leaks.  
Retune the symbol to the live scale. Audit. Fallback when the scale leaves the positivity belt.

PHOTOS = physical / sensor field.  
